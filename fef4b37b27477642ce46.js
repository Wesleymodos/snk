...
const createViewer = ({ grid0, chain, cells, drawOptions, }) => {
    //
    // canvas
    ...
    const svgString = (0,_snk_svg_creator__WEBPACK_IMPORTED_MODULE_5__.createSvg)(grid0, cells, chain, drawOptions, {
        frameDuration: 100,
    });
